...
const (
	...
	CLOUDINARY_UPLOAD_URL     string = "CLOUDINARY_UPLOAD_URL"
	...
	CLOUDINARY_STORAGE_FOLDER string = "CLOUDINARY_STORAGE_FOLDER"
	GROQ_API_URL              string = "GROQ_API_URL"
	GROQ_MODEL                string = "GROQ_MODEL"
)
