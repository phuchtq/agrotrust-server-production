...
type CreateRegistrationRequest struct {
	RegisterRole       string `json:"register_role" form:"register_role" validate:"required"`
	...
	AvatarBase64       string `json:"avatar_base_64" form:"avatar_base_64" validate:"required"`
}
